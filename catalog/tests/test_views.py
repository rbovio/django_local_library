...
from django.contrib.auth.models import User, Permission  # Required to assign User as a borrower. Required to grant the permission needed to set a book as returned.
from catalog.models import BookInstance, Book, Genre, Author
import uuid


# Testing generic list views
...
class RenewBookInstancesViewTest(TestCase):
    def setUp(self):
        ...
        permission = Permission.objects.get(name='Can mark returned')
    ...
    # This checks that the view redirects to a list of all borrowed books if renewal succeeds.
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        ...
        self.assertRedirects(response, reverse('all-borrowed'), target_status_code=403)




    # These again test POST requests, but in this case with invalid renewal dates.
